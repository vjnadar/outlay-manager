...
exports.getAllData = (req, res, next) => {
    res.status(200).json({ message: "Data retrieval was successful", data: tempData });
};
...
exports.getDateData = async (req, res, next) => {
    ...
    let date = moment(req.params.date).utc(true).format("YYYY-MM-DD");
...
exports.updateEntry = async (req, res, next) => {
    ...
    const userId = ObjectId(req.userId);
    const newEntryToBeSaved = new Entry(entryId, userId, flowtype, type, amount, date, time);
    try {
